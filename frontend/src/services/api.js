...
export const addMasterRecord = (type, data) => api.post(`/master/${type}`, data);
export const updateMasterRecord = (type, id, data) => api.put(`/master/${type}/${id}`, data);
export const deleteMasterRecord = (type, id) => api.delete(`/master/${type}/${id}`);
