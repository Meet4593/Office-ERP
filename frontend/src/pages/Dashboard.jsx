  ...
  return (
    <Box sx={{ flexGrow: 1, p: { xs: 1, md: 3 } }}>
      ...
      >
        ...
        <Paper sx={{ p: 3, borderRadius: 4, boxShadow: '0 4px 20px 0 rgba(0,0,0,0.05)', height: '100%', minHeight: 400 }}>
        ...
        <Paper sx={{ p: 0, borderRadius: 4, boxShadow: '0 4px 20px 0 rgba(0,0,0,0.05)', overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column', minHeight: 400 }}>
